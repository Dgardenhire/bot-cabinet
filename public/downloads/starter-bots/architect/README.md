...
Founders and small teams that need senior technical judgment before building, buying, or rebuilding software.
...
4. Begin with this test: Review a small architecture packet and produce a one-page decision record comparing two options.

## Review status

On August 28, 2026, Bot Cabinet confirmed that the ZIP and Hermes profile archive contain the six listed files and match the readable copies. Bot Cabinet has not individually imported this archive into Hermes Desktop. No human technical reviewer has reviewed this template, and its role-specific output has not been tested.
