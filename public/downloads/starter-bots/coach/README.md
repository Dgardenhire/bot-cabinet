...
People considering a transition or trying to turn a broad direction into practical next steps.
...
4. Begin with this test: Use one current, low-stakes decision to compare two options and define one reversible next step.
