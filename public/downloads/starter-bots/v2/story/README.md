...
4. Run this first mission with sample material: Use three approved source documents to create a one-page narrative brief and mark every unsupported claim.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/story.md
