# Planner — Project planning assistant
...
4. Run this first mission with sample material: Create a two-week plan from one approved objective and identify every missing decision.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/planner.md
