...
4. Run this first mission with sample material: Use one venture concept and approved public sources to create an assumption ledger and one no-spend test plan.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/nova.md
