...
4. Run this first mission with sample material: Edit a two-page memo and explain the five most important changes.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/editor.md
