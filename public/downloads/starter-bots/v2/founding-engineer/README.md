# Founding Engineer — Early product and prototyping assistant
...
4. Run this first mission with sample material: Build one small workflow in a disposable project copy, run its acceptance check, and demonstrate the result.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/founding-engineer.md
