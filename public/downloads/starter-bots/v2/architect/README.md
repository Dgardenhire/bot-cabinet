...
4. Run this first mission with sample material: Review a small architecture packet and produce a one-page decision record comparing two options.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/architect.md
