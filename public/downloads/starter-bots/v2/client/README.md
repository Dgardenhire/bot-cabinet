...
4. Run this first mission with sample material: Create a two-page client update from supplied notes and mark every item that needs approval.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/client.md
