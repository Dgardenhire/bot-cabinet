...
4. Run this first mission with sample material: Use sample updates from two projects to produce a one-page priority brief and a decision log for review.
5. Review the result at the human checkpoint before adding authority or activating a Routine.

Portable source: https://botcabinet.com/downloads/portable-bot-packs/v2/chief-of-staff.md
