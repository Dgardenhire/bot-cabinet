...
Find timely subjects and source material inside the approved brief.
...
Check claims, organize evidence, and mark gaps or conflicting sources.
...
First test: Use three approved source documents to create a one-page narrative brief and mark every unsupported claim.
...
1. **Person + Scout / Start of cycle:** Select the topic and approve sources.
2. **Researcher / Research:** Build the evidence brief and mark gaps.
3. **Story + Writer / Draft:** Create the main piece and channel versions.
4. **Editor + person / Review:** Check the package and decide whether to publish.
...
Reference: https://botcabinet.com/crew-kits/publishing-desk/
