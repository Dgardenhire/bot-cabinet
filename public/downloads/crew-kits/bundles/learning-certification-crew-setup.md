# Learning and Certification Crew — guided setup
...
Collect and organize approved official materials.
...
Explain concepts and create practice questions.

Archive: members/professor.tar.gz
SHA-256: 46661088274f609a8c02a7287b001c22392b21f25213f9d20421fb9c31bc30cd
Pack: 2.0.0; minimum Hermes: >=0.21.0; import tested with: 0.21.0
Import: import-test-passed; skill: not-tested; routine: inactive; manual-test-required
...
First test: Assess one narrow topic and produce a one-week study plan with five practice questions.
...
Build and adjust the study schedule.
...
1. **Researcher + Planner / Plan:** Map official material to a realistic sequence.
2. **Professor / Learn:** Explain the current topic and examples.
3. **Coach / Practice:** Run a quiz and record errors.
4. **Planner + learner / Review:** Adjust the next cycle from progress.
...
Reference: https://botcabinet.com/crew-kits/learning-certification-crew/
