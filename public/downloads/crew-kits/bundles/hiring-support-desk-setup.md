# Hiring Support Desk — guided setup

Bundle 1.0.0

Prepare a role brief, interview materials, candidate research, and structured notes for a human hiring process.
...
Create the approved role brief and candidate-facing drafts.
...
Organize supplied job-relevant information without scoring people.
...
Build the interview plan, question set, and schedule.
...
Check clarity, consistency, and missing criteria.
...
1. **Writer + Planner + person / Role definition:** Approve responsibilities, evidence, and process.
2. **Researcher + Planner / Preparation:** Organize material and prepare consistent questions.
3. **Editor / Interview record:** Format factual notes and open questions.
4. **Hiring manager / Decision:** People make every employment decision.
...
- Contact, advance, rank, reject, or select a candidate
- Discuss compensation or background checks
- Use sensitive personal information

## Success measures
- [ ] Interviewers use approved job-relevant criteria
- [ ] Notes separate observations from conclusions
- [ ] No Bot ranks, rejects, or selects candidates

Reference: https://botcabinet.com/crew-kits/hiring-support-desk/
