# Grant Pursuit Desk — guided setup

Bundle 1.0.0

Find promising funding opportunities, check eligibility, and turn the strongest option into a proposal work plan.
...
Find current opportunities matching the approved mission, geography, and funding range.
...
Verify eligibility, deadlines, requirements, and official language.
...
Build the work plan, evidence checklist, assignments, and schedule.
...
1. **Scout / Discovery:** Find opportunities and preserve official source links.
2. **Researcher + person / Eligibility:** Check threshold requirements and prepare a decision brief.
3. **Planner + Writer / Development:** Build the evidence plan and draft approved sections.
4. **Editor + person / Compliance:** Review the package and route open questions.
...
- Represent organizational eligibility or performance
- Set a budget, target, or commitment
- Contact a funder or submit an application

## Success measures
- [ ] Eligibility conclusions point to official language
- [ ] The proposal uses approved facts
- [ ] A person approves the application and submission

Reference: https://botcabinet.com/crew-kits/grant-pursuit-desk/
