# Weekly Business Review — guided setup
...
Gather approved metrics, project status, deadlines, and exceptions.
...
Act as Analyst and explain changes, gaps, and possible causes.
...
Turn approved decisions into owners, actions, and dates.
...
1. **Ops / Gather:** Collect metrics, work status, and exceptions.
2. **Researcher / Interpret:** Explain movement and mark unreliable data.
3. **Chief of Staff + person / Decide:** Present conflicts and questions.
4. **Planner / Commit:** Record approved priorities, owners, and dates.
...
- Change a priority, assignment, deadline, or metric
- Message a client or team member
- Make a financial or personnel decision

## Success measures
- [ ] Every metric uses an agreed definition and source
- [ ] Conflicts and weak evidence are visible
- [ ] Every approved action has an owner and date

Reference: https://botcabinet.com/crew-kits/weekly-business-review/
