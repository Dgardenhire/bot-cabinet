...
2. Run this first mission with sample material: Use one venture concept and approved public sources to create an assumption ledger and one no-spend test plan.
...
Complete V2 pack: https://botcabinet.com/downloads/portable-bot-packs/v2/nova.md
Bot Cabinet record: https://botcabinet.com/bots/nova/
