...
- Audiences, channels, and desired response
- Voice examples, protected language, and off-limit claims

## Workflow

### 1. Researcher

Organize the confirmed facts, sources, contradictions, and evidence gaps

Output: A source and proof-point brief
...
Output: A narrative brief and audience message map

Message to send:

Start with this result from Researcher: A source and proof-point brief. Build the central narrative and adapt its message structure by audience. Return this result: A narrative brief and audience message map. Ask me about missing information before you continue.

### 3. Writer

Turn the approved message map into reusable channel drafts

Output: A message kit with sample website, email, and social copy
...
- Decide the central meaning and positioning
- Approve proof points, quotations, testimonials, and public claims
- Approve final wording and any publication or distribution
