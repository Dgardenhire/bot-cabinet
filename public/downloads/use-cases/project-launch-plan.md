...
Designed for: Teams preparing a product, event, campaign, or internal initiative

Result: A launch plan with confirmed priorities, milestones, owners, dependencies, decision dates, and a message map.
...
- Confirmed launch objective and target date
- Available people and budget
- Known requirements, risks, evidence, and audiences
...
Create a launch plan from this confirmed objective. Separate open ideas from approved work, list milestones, owners, dependencies, decision dates, and risks, then build a message map from the approved facts.

## Decisions for a person

- Confirm priorities, owners, and dates
- Resolve budget, capacity, and risk decisions
- Approve the message and every public claim

## First test

Build a plan for a small internal launch and review every assignment with the named owner.
