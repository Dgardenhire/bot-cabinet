...
export const AGENT_WATCH_SEED: AgentWatchItem[] = [
  {
    ...
    "sources": [
      {
        "label": "Official Grok Bot Marketplace listing",
        "href": "https://x.ai/bot/marketplace/bots/import-bot"
      }
    ],
    "cabinetLinks": [
      {
  ...
  },
  {
    ...
    "sources": [
      {
        "label": "Official Grok Bot Marketplace listing",
        "href": "https://x.ai/bot/marketplace/bots/tinkabot"
      }
    ],
    "cabinetLinks": [
      {
        "label": "Read the Hermes profile guide",
        "href": "/guides/install-a-profile"
      }
    ],
    "botDetails": {
      "name": "tinkabot",
  ...
  },
  {
    ...
    "signal": "Yanqing Cheng shared a Grok Bot that helps when a task feels hard to begin. It asks short questions one at a time instead of making a large plan.",
    "evidence": "observed",
    "whyItMatters": "A long plan can become one more obstacle. This narrower approach may help someone find one manageable action and begin it.",
    "cabinetResponse": "Test this as a possible new standalone Bot. Compare it with Coach and Planner using the same stalled task, and keep it only if the smaller approach helps someone start sooner.",
    "responseStatus": "testing",
    "limits": "Bot Cabinet has reviewed the public description and links but has not run the Grok template or built a Hermes adaptation.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/YanqingCheng/status/2099206038368977179"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/EahHaI-kwO0hgWj6I45jC"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/unstick-me-bot"
      }
    ],
    "cabinetLinks": [
      {
        "label": "Compare with Coach",
        "href": "/bots/coach"
      },
      {
        "label": "Compare with Planner",
        "href": "/bots/planner"
      }
    ],
    "botDetails": {
  ...
  },
  {
    ...
    "signal": "A public Grok Bot template accepts statement files or screenshots, finds likely duplicates, suggests categories and shows a preview before anything is saved.",
    "evidence": "observed",
    "whyItMatters": "The useful pattern is the preview before the write. It can reduce repetitive entry while leaving the final categories and changes with the person using it.",
    "cabinetResponse": "Test an adaptation as a new Bot because Receipt handles returns and warranties, not transaction entry. Begin with made-up records and require approval before any file is changed.",
    "responseStatus": "testing",
    "limits": "Bot Cabinet has not run the template or checked its duplicate detection. Financial files can contain sensitive information and should not be connected during an early test.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/coolbat1999/status/2099141007887777987"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/A3pcjyO0dAkvRGxD4VGeH"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/bill-import-bot"
      }
    ],
    "cabinetLinks": [
      {
  ...
  },
  {
    ...
    "signal": "A shared Grok Bot watches a running job and sends a warning only when it passes a time limit, repeats itself or reports an error.",
    "evidence": "observed",
    "whyItMatters": "A useful monitor should reduce checking, not create a second stream of noise. Clear warning rules make this pattern useful for long-running work.",
    "cabinetResponse": "Use the idea to improve Ops and Cabinet Keeper rather than add a near-duplicate Bot. A first test should watch one harmless job with a clear time limit and one place for alerts.",
    "responseStatus": "watching",
    "limits": "Bot Cabinet has not run the template. A monitor needs exact rules, limited access and a reliable way to avoid duplicate or false warnings.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/WeirdBotDrop/status/2096625291531538791"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/1JxNBfQ05cVYJGLLh6R-o"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/stuck-signal-bot"
      }
    ],
    "cabinetLinks": [
      {
  ...
  },
  {
    ...
    "signal": "A shared Grok Bot turns updates from different chats or agents into one current status file, with decisions, open questions and next steps.",
    "evidence": "observed",
    "whyItMatters": "Work becomes hard to resume when important decisions are scattered. One short, dated record can make handoffs and restarts much easier.",
    "cabinetResponse": "Use this pattern to improve Reentry rather than create another project-resumption Bot. Test whether it can update one record without erasing disagreement or treating a guess as a decision.",
    "responseStatus": "watching",
    "limits": "Bot Cabinet has not run the template. A combined record can hide conflicting accounts unless every change keeps its source and date.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/hudcos/status/2097309182584094975"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/pOcrH-Rc7SdPWiHsX9vHg"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/canonizer-bot"
      }
    ],
    "cabinetLinks": [
      {
  ...
  },
  {
    ...
    "signal": "A shared Grok Bot builds and updates a personal profile that can help another assistant understand preferences, goals and working style.",
    "evidence": "observed",
    "whyItMatters": "People repeat the same background whenever they start with a new assistant. A portable brief could save time, but it can also collect more private information than the job needs.",
    "cabinetResponse": "Study the idea before adapting it. Any Cabinet version should let a person see, edit and remove every saved fact, and should explain which details are unnecessary for the current job.",
    "responseStatus": "watching",
    "limits": "Bot Cabinet has not tested the template. A personal profile can become inaccurate, overly revealing or difficult to move safely between services.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/TAftermath2020/status/2099183022193123784"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/7dfQ6zC2X2hmnIlnF4rSN"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/about-me-bot"
      }
    ],
    "botDetails": {
      "name": "About Me Bot",
  ...
  },
  {
    ...
    "signal": "A shared Grok Bot starts with a resume and location, finds likely openings and checks the listings before presenting them.",
    "evidence": "observed",
    "whyItMatters": "Job search is a strong fit for focused research, but a useful result needs a current opening and a clear reason it matches—not a long list of scraped titles.",
    "cabinetResponse": "Treat this as a new use case for Scout, not a new Bot. Test it with a made-up resume and require a direct employer link, location check and short explanation for every result.",
    "responseStatus": "watching",
    "limits": "Bot Cabinet has not run the template or checked the quality of its matches. Job listings expire quickly and a public post may not reflect current behavior.",
    "sources": [
      {
        "label": "Creator's post",
        "href": "https://x.com/NickRoman/status/2097381626955055254"
      },
      {
        "label": "Open the Grok Bot template",
        "href": "https://x.ai/bot/jc0tOHuVUAn4MHuH2zyDn"
      },
      {
        "label": "GrokHub listing",
        "href": "https://www.grokhub.io/use-cases/scouty-bot"
      }
    ],
    "cabinetLinks": [
      {
