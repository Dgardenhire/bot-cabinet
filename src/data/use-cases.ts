...
export const BOT_USE_CASES: BotUseCase[] = [
  ...
  },
  {
    ...
    setupNote: "One Coder can handle a small update from approved facts and copy. Add Researcher when facts need substantial checking, or Writer when the page needs a separate editorial pass.",
    inputs: ["The existing page and code project", "Approved facts and requested change", "Design reference and acceptance checks"],
    steps: [
      { bot: "Coder", action: "Check the supplied facts, revise the page within the existing design, and run the project checks", output: "Updated copy and code, source notes, changed files, and verification results" },
    ],
  ...
  },
  {
    ...
    botSlugs: ["nova"],
    optionalBotSlugs: ["researcher", "pulse"],
    setupNote: "One Nova can evaluate an early idea and propose a small test. Add Researcher for a deeper evidence review, or Pulse when a live experiment needs dedicated measurement.",
    inputs: ["The idea and its current status", "The intended customer and problem", "Existing evidence, budget, time, and risk limits"],
    steps: [
      { bot: "Nova", action: "Separate facts from assumptions, check the most important unknowns in the approved sources, and design one low-cost test", output: "A venture brief, evidence notes, and a test with success, revise, and stop rules" },
    ],
  ...
  },
  {
    ...
    botSlugs: ["founding-engineer"],
    optionalBotSlugs: ["nova", "architect"],
    setupNote: "One Founding Engineer can compare practical options and build a narrow prototype. Add Nova when the product question is still unclear, or Architect for a high-consequence technical decision.",
    ...
    steps: [
      { bot: "Founding Engineer", action: "Clarify the next product question, compare practical technical options, and build only the smallest approved prototype", output: "A decision record, working prototype, acceptance-check results, and remaining questions" },
    ],
