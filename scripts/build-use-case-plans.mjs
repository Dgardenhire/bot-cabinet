  ...
  const lines = [
    ...
    ...(useCase.adaptations?.length ? [
      ...
      ...useCase.adaptations.flatMap((adaptation) => [
        ...
        `- **Known limit:** ${adaptation.limitations}`,
        ...(adaptation.source ? [`- **Original source:** [${adaptation.source.label}](${adaptation.source.href})`] : []),
        ...(adaptation.cabinetGuide ? [`- **Cabinet guide:** https://botcabinet.com${adaptation.cabinetGuide}/`] : []),
        "",
      ]),
    ] : []),
